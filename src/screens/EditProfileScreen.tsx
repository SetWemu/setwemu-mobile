...
const EditProfileScreen = ({ navigation }: any) => {
  ...
  const handleSave = () => {
    ...
    console.log('Saved data:', { name, username, email, fullPhone, fullLocation, bio, website });
    navigation.goBack();
  };
  ...
  // Dark theme config for the country picker modal
...
const styles = StyleSheet.create({
  ...
  cameraBadge: {
    ...
    backgroundColor: '#38bdf8', padding: 8, borderRadius: 20,
    borderWidth: 3, borderColor: '#0F172A',
  },
  formContainer: { padding: 20 },
  inputGroup: { marginBottom: 20 },
  label: {
    color: '#94a3b8', marginBottom: 8, fontSize: 13,
  ...
  countryPickerButton: {
    ...
    height: 54, // Matches the height of the TextInput
  },
});
